            ...
            <div className='flex flex-col gap-4'>
                <a href='#'>
                    <div className='group relative col-span-3 flex flex-col justify-between overflow-hidden rounded-xl transform-gpu bg-background [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] min-h-[300px] sm:min-h-[400px] md:min-h-[500px]'>
                        <div>
                            <img src='react_portfolio.png' className='absolute left-0 top-0 h-full w-full border-none transition-all duration-300 ease-out opacity-70 [mask-image:linear-gradient(to_top,transparent_20%,#000_100%)] group-hover:scale-105 object-center'></img>
                        </div>
                        <div className='pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10'>
                            <h1 className='text-xl font-semibold text-neutral-700 dark:text-neutral-300 m-0 custom'>React Portfolio</h1>
                            <div className='flex gap-2 mt-1 custom flex-wrap'>
                                <div className='border border-zinc-700 rounded-md p-2 flex items-center custom mb-0 gap-2'>
                            ...
                            <p className="max-w-lg text-neutral-400 m-0 custom">Full-Stack Developer portfolio</p>
                        </div>
                ...
                <a href='#'>
                    <div className='group relative col-span-3 flex flex-col justify-between overflow-hidden rounded-xl transform-gpu bg-background [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] min-h-[300px] sm:min-h-[400px] md:min-h-[500px]'>
                        <div>
                            <img src='journal.png' className='absolute left-0 top-0 h-full w-full border-none transition-all duration-300 ease-out opacity-70 [mask-image:linear-gradient(to_top,transparent_20%,#000_100%)] group-hover:scale-105 object-center'></img>
                        </div>
                        <div className='pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10'>
                            <h1 className='text-xl font-semibold text-neutral-700 dark:text-neutral-300 m-0 custom'>Journal</h1>
                            <div className='flex gap-2 mt-1 custom flex-wrap'>
                                <div className='border border-zinc-700 rounded-md p-2 flex items-center custom mb-0 gap-2'>
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0,0,256,256">
                                        <g fill="#ffffff" fillRule="nonzero"><g transform="scale(5.12,5.12)"><path d="M43.33594,4h-36.66797c-1.47266,0 -2.66797,1.19531 -2.66797,2.66797v36.66406c0,1.47266 1.19531,2.66797 2.66797,2.66797h36.66406c1.47266,0 2.66797,-1.19531 2.66797,-2.66406v-36.66797c0,-1.47266 -1.19531,-2.66797 -2.66406,-2.66797zM27,36.18359c0,3.99609 -2.34375,5.81641 -5.76562,5.81641c-3.09375,0 -5.32422,-2.07422 -6.23437,-4l3.14453,-1.90234c0.60547,1.07422 1.52734,1.90234 2.85547,1.90234c1.26953,0 2,-0.49609 2,-2.42578v-12.57422h4zM35.67578,42c-3.54297,0 -5.55469,-1.78516 -6.67578,-4l3,-2c0.81641,1.33594 1.70703,2.61328 3.58984,2.61328c1.58203,0 2.41016,-0.78906 2.41016,-1.88281c0,-1.30469 -0.85937,-1.76953 -2.59766,-2.53125l-0.95312,-0.41016c-2.75391,-1.17187 -4.58594,-2.64062 -4.58594,-5.75c0,-2.85937 2.18359,-5.03906 5.58984,-5.03906c2.42578,0 4.16797,0.84375 5.42578,3.05469l-2.96875,1.91016c-0.65625,-1.17578 -1.35937,-1.63672 -2.45703,-1.63672c-1.11719,0 -1.82422,0.71094 -1.82422,1.63672c0,1.14453 0.70703,1.60547 2.34375,2.31641l0.95313,0.41016c3.24609,1.38672 5.07422,2.80469 5.07422,5.99219c0,3.43359 -2.69922,5.31641 -6.32422,5.31641z"></path></g></g>
                            ...
                            <p className="max-w-lg text-neutral-400 m-0 custom">A journalling website with theming and customization</p>
                        </div>
                        <div className="pointer-events-none absolute bottom-0 flex w-full translate-y-10 transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 custom ml-2"><div className="pointer-events-auto custom bg-white rounded-lg py-1 px-2 text-xs text-black flex gap-2 items-center cursor-pointer hover:bg-white/80 transition-colors">Learn more<div className="ml-2 h-4 w-4 icn"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.14645 3.14645C8.34171 2.95118 8.65829 2.95118 8.85355 3.14645l4.00005 4c.1952.19526.1952.51184.0.707100000000001L8.85355 11.8536C8.65829 12.0488 8.34171 12.0488 8.14645 11.8536c-.19527-.1953-.19527-.511900000000001.0-.7072L11.2929 8H2.5C2.22386 8 2 7.77614 2 7.5s.22386-.5.5-.5h8.7929L8.14645 3.85355c-.19527-.19526-.19527-.51184.0-.7071z" fill="currentcolor" fillRule="evenodd" clipRule="evenodd"></path></svg></div></div></div>
                    </div>
                </a>
