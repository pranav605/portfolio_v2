...
export default function Contact() {
    return (
        <main className="content mt-16 text-sm sm:text-lg mb-16 m-auto font-sans max-w-[60rem] min-h-screen px-4">
            <div className="max-w-[50rem] m-auto h-full">
                <div className="rounded-md border border-zinc-800 p-5 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row justify-around items-center gap-10 mt-10 flex-wrap">
                        {/* Discord */}
                        <a
                            href="http://discord.com/users/pranav605"
                            target="_blank"
                        ...
                        {/* Email */}
                        <a
                            href="mailto:saipranavnishtala@gmail.com"
                            className="flex flex-col gap-2 items-center text-center"
                        >
                            ...
                            <p className="text-gray-400 font-semibold text-base break-all">saipranavnishtala@gmail.com</p>
                        </a>

                        {/* LinkedIn */}
                        <a
                            href="https://www.linkedin.com/in/sai-pranav-nishtala/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex flex-col gap-2 items-center text-center"
                        >
                            ...
                            <p className="text-gray-400 font-semibold text-base break-all">/sai-pranav-nishtala</p>
                        </a>
                    </div>
                </div>
            </div>
